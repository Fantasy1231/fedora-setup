...
#   curl -fsSL https://raw.githubusercontent.com/keirfantasy/fedora/main/bootstrap.sh | bash -s -- --desktop
#
...
SCRIPT_URL="https://raw.githubusercontent.com/keirfantasy/fedora/main/fedora-setup.sh"
